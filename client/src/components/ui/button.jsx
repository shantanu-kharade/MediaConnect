...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 shadow-elegant hover:shadow-elegant-lg",
        destructive:
        ...
        gold:
          "bg-gradient-to-r from-gold to-gold-light text-accent-foreground font-semibold shadow-glow hover:shadow-elegant-lg hover:scale-[1.02]",
        elegant:
          "bg-card border border-border text-foreground hover:border-gold hover:shadow-glow",
      },
      size: {
